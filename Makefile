all:
	...
	aarch64-none-elf-gcc -nostdlib -ffreestanding -O2 -Wall -Wextra -I. -c startup/vector.S -o vec.o
	...
	aarch64-none-elf-ld -T link.ld startup.o main.o vec.o -o os.elf
	...
	rm main.o os.elf startup.o vec.o
